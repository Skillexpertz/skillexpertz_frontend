...
const Blobs = () => {
    return (
        <>
            ...
            <div className="absolute bottom-20 right-0 w-40 h-40 sm:w-56 sm:h-56 md:w-80 md:h-80 md:-right-20 bg-gradient-to-r from-[#5F2DED] to-[#F2277E] rounded-full blur-3xl opacity-20 animate-pulse"></div>
        </>
    )
}
